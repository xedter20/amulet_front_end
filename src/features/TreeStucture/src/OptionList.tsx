...
import { getAllKeys, isCheckDisabled } from './utils/valueUtil.ts';
...
const OptionList: React.RefForwardingComponent<ReviseRefOptionListProps> = (
  _,
  ref
) => {
  const {
